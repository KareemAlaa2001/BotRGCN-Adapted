...
from augmodels import TweetAugmentedHAN, TweetAugmentedRGCN, TweetAugmentedHAN2, TweetAugmentedHAN2ExtraLayer
...
def trainTestHetero(embedding_size = 128, dropout = 0.3, lr = 1e-3, weight_decay = 5e-3, svdComponents = 100, thirds = False, epochs = 100):
...
trainTestHetero(embedding_size, dropout, lr, weight_decay, svdComponents, thirds, epochs)
